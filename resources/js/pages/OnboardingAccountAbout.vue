...
const props = withDefaults(
    defineProps<{
        accountAbout?: 'business' | 'person' | 'other' | null;
    }>(),
    {
        accountAbout: null,
    },
...
const form = useForm<{ account_about: 'business' | 'person' | 'other' | '' }>({
    account_about: props.accountAbout || '',
});

const submit = () => {
    if (!form.account_about) return;
    form.post('/onboarding/account-about');
};
</script>
            ...
            <div class="w-full max-w-xl">
                ...
                <div class="space-y-3">
                    ...
                    >
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-sm font-medium text-neutral-900">A business</span>
                        </div>
                        <input
                            v-model="form.account_about"
                            type="radio"
                            name="account_about"
                            value="business"
                    ...
                    >
                        <div class="flex items-center gap-3">
                            <div class="flex size-9 items-center justify-center rounded-lg bg-neutral-100 text-neutral-700">
                                <span class="text-xs font-bold">PE</span>
                            </div>
                            <span class="text-sm font-medium text-neutral-900">A person</span>
                        </div>
                        <input
                            v-model="form.account_about"
                            type="radio"
                    ...
                    >
                        <div class="flex items-center gap-3">
                            <div class="flex size-9 items-center justify-center rounded-lg bg-neutral-100 text-neutral-700">
                                <span class="text-xs font-bold">OT</span>
                            </div>
                            <span class="text-sm font-medium text-neutral-900">Other</span>
                        </div>
                        <input
                            v-model="form.account_about"
                            type="radio"
                ...
                <div class="mt-8 flex items-center justify-between">
                    ...
                    <button
                        ...
                        :disabled="form.processing || !form.account_about"
                        @click="submit"
                    >
